...
Usage:
    run.py train --train-src=<file> --train-tgt=<file> --dev-src=<file> --dev-tgt=<file> --vocab=<file> --slang=<int> --tlang=<int> [options]
    run.py decode [options] MODEL_PATH TEST_SOURCE_FILE OUTPUT_FILE
    run.py decode [options] MODEL_PATH TEST_SOURCE_FILE TEST_TARGET_FILE OUTPUT_FILE --slang=<int> --tlang=<int>
...
Options:
    ...
    --patience=<int>                        wait for how many iterations to decay learning rate [default: 6]
...
def train(args: Dict):
    ...
    hist_valid_scores = [-4.833704, - 4.704779] #-4.019014, -3.957752] 
    ...
    while True:
        ...
        for src_sents, tgt_sents in batch_iter(train_data, train_batch_size, slang, tlang, shuffle=True):
            ...
            batch_loss = (example_losses1.sum() + example_losses2.sum()) / 2
...
def beam_search(model, test_data_src, beam_size, max_decoding_time_step, tlang): 
    ...
    print(tlang, "tlang == en : {}".format(tlang == '1' ))
