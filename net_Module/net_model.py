...
class Net(nn.Module): #Word Mapping
    ...
    def forward(self, dictionary, trained_mapping, slang, nul_mapping=True): 
        ...
        self.mapping.weight.data = W #if nul_mapping else 0.9*W + 0.1*trained_mapping.weight.data
