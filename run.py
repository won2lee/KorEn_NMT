...
def train(args: Dict):
    ...
    #hist_valid_scores = [-3.913067]
    #hist_valid_scores = [-3.913643]
    #hist_valid_scores = [-3.847226]   # new_dev_set2 lr=0.000136 new_BLEU=39.21       /36.508/36.312
    #hist_valid_scores = [-3.827181]
    #hist_valid_scores = [-4.020948]
    #hist_valid_scores = [-4.007567]
    #hist_valid_scores = [-3.971073]

    #hist_valid_scores = [-3.838783]
    #hist_valid_scores = [-3.86]

    #hist_valid_scores = [-3.851925] 
    #hist_valid_scores = [-3.835915]
    #hist_valid_scores = [-3.823552] #bleu 39.60
    #hist_valid_scores = [-3.819090]
    #hist_valid_scores = [-3.816251]
    #hist_valid_scores = [-3.813872]
    #hist_valid_scores = [-3.811124] #bleu39.10
    #hist_valid_scores = [-3.811353]
    #hist_valid_scores = [-3.805243]
    #hist_valid_scores = [-3.806867] #bleu39.634
    #hist_valid_scores = [-3.795704] #bleu39.86
    #hist_valid_scores = [-3.795039]
    #hist_valid_scores = [-3.790673] #bleu 39.64
    #hist_valid_scores = [-3.797838]  #bleu 39.52
    #hist_valid_scores = [-3.782797]
    #hist_valid_scores = [-3.782576]
    #hist_valid_scores = [-3.769942]
    #hist_valid_scores = [-3.7722]
    #hist_valid_scores = [-3.75887]  #bleu 39.66
    #hist_valid_scores = [-3.745650]  #bleu 39.865
    #hist_valid_scores = [-3.749973] #bleu 39.869
    #hist_valid_scores = [-3.740634] #bleu 39.88 ...10/12
    #hist_valid_scores = [-3.744939] #bleu 39.91 40.06(수정)  ...10/12
    #hist_valid_scores = [-3.735756]  # best record
    #hist_valid_scores = [-3.741184] #bleu 39.91
    #hist_valid_scores = [-3.739179] #bleu 40.06 best score 40.229(수정)
    #hist_valid_scores = [-3.740852]  #bleu 39.96 40.09(수정)
    #hist_valid_scores = [-3.736736] #bleu 40.00
    #hist_valid_scores = [-3.742931] #bleu 40.26 best score 40.24(수정) ...10/14
    #hist_valid_scores = [-3.736798] # bleu 40.04  40.29(수정) best score
    #hist_valid_scores = [-3.731968]  # best record   bleu 40.03  40.03(수정)
    #hist_valid_scores = [-3.733086]
    #hist_valid_scores = [-3.741142] # train dataset 수정후 10/15 bleu 40.07
    #hist_valid_scores = [-3.737524]  # bleu 40.03
    #hist_valid_scores = [-3.736907] # bleu39.82
    #hist_valid_scores = [-3.730359]  # bleu39.67
    #hist_valid_scores = [-3.732674] #39.94
    ###hist_valid_scores = [-3.723188] # best record 10/17 bleu 39.92
    #hist_valid_scores = [-3.715544] # best record 10/17 bleu 39.93
    #hist_valid_scores = [-3.714679] # best record 10/17 bleu 40.229
    #hist_valid_scores = [-3.711262]  # best record 10/19 bleu 39.81
    #hist_valid_scores = [-3.720860] #bleu 39.85
    #hist_valid_scores = [-3.724059]
    #hist_valid_scores = [-3.438081] #39.946
    #hist_valid_scores = [-3.442628] #40.036
    #hist_valid_scores = [-3.433866] #bleu 39.97
    #hist_valid_scores = [-3.440681]  #bleu 40.05
    #hist_valid_scores = [-3.427457] #bleu 39.71
    #hist_valid_scores = [-3.440]  #bleu 40.11
    #hist_valid_scores = [-3.428905] #39.84
    #hist_valid_scores = [-3.436964]
    #hist_valid_scores = [-3.449274] #bleu 39.96
    #hist_valid_scores = [-3.440189] #bleu 39.62
    #hist_valid_scores = [-3.432864] #bleu 39.93
    #hist_valid_scores = [-3.420931] #bleu 39.70213205285503
    #hist_valid_scores = [-3.414640]  #bleu 40.23
    #hist_valid_scores = [-3.412773] #bleu 40.33
    #hist_valid_scores = [-3.444] #bleu  40.21 ---noChar translation quality is not bad
    #hist_valid_scores = [-3.432201] # bleu 40.14  ---- noChar 10/30
    #hist_valid_scores = [-3.435383]
    #hist_valid_scores = [-3.435383]
    #hist_valid_scores = [-3.615608] # best record bleu 40.05
    #hist_valid_scores = [-3.625375]
    #hist_valid_scores = [-3.618745] #
    #hist_valid_scores = [-3.602209]
    #hist_valid_scores = [-3.612420]
    #hist_valid_scores = [-3.610663]
    #hist_valid_scores = [-3.604410] #bleu 40.18
    #hist_valid_scores = [-3.603686] #bleu 40.04
    #hist_valid_scores = [-3.601452] #bleu 40.07
    #hist_valid_scores = [-3.601017] #bleu 39.935
    #hist_valid_scores = [-3.607] #bleu 40.36
    #hist_valid_scores = [-3.593780] #best record bleu 39.90
    #hist_valid_scores = [-3.606388]
    #hist_valid_scores = [-3.591712] 39.861
    #hist_valid_scores = [-3.596297]
    #hist_valid_scores = [-3.604363]
    #hist_valid_scores = [-3.529302]
    #hist_valid_scores = [-3.514448, -3.511006, -3.509211, -3.505952 ]
