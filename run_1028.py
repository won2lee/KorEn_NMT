...
Options:
    ...
    --patience=<int>                        wait for how many iterations to decay learning rate [default: 50]
    ...
    while True:
        ...
        #for i_of_iter in range(len(train_data)//train_batch_size):
            ...
            if train_iter % valid_niter ==1:
                ...
                """
                if back_trans_X ==1:
                    #back_trans = 1 if n_X in list(range(nK,nK+nK)) and mapping==0 and self_trans==0 and bt_batch>0 else 0
                    back_trans = 1
                    """
                    if self_trans_X ==1:                        
                ...
                if (back_trans ==1 and bt_batch < 1) or (self_trans ==1 and st_batch ==0): 
                    ...
                    for ik,sl in enumerate(['ko2en', 'en2ko']):
                        ...
                        if back_trans_X==1:
                            ...
                            mK = 1 if self_trans_X ==1 else 5  #if back trans only, mK = 1, elif mix with normal then mK=5
            ...
            if back_trans==1:
                ...
                #print('\n',src_sents3[7]) 
                #print(tgt_sents3[7],'\n')
                if self_trans_X ==1: # self_trans ==1:
                ...
                if self_trans_X ==1: # self_trans ==1:  # 설명 : self_trans_X ==1 로 할 경우의 설명 : 현재 iter에서 self_trans 가 1 이 아니더라도 self_trans_X 가 1이면 단독으로 (메모리 문제도 고려)
            ...
            if train_iter % valid_niter == 0:
                ...
                is_better = len(hist_valid_scores) == 0 or valid_metric > max(hist_valid_scores) - (patience + 1) * (0.00002 +mapping*0.0002)
